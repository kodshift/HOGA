...
//Render api 
//https://hogamilanbackend-2.onrender.com/api/data 
...
const Datasubmitform = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch("https://expertapp-86aba-default-rtdb.firebaseio.com/hogamilan.json", {
        method: "POST",
        headers: {
  ...
  const handleSignout = () => {
    signOut(database)
      .then(() => {
        ...
        // Navigate to the home page or any desired page after logout
        navigate("/");
      })
      .catch((error) => {
